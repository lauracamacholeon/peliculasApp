...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(peliculaService) {
        this.peliculaService = peliculaService;
        this.peliculas = [];
        this.peliculasSlider = [];
    }
    ...
    HomeComponent.prototype.onScroll = function () {
        ...
        var posicion = (document.documentElement.scrollTop || document.body.scrollTop) + 1300;
        // altura scroll
        var maximoScroll = (document.documentElement.scrollHeight || document.body.scrollHeight);
        ...
        if (posicion > maximoScroll) {
            ...
            this.peliculaService.getCartelera().subscribe(function (respuesta) {
                var _a;
                // le va a añadir a lo ya traia la respuesta nueva 
                (_a = _this.peliculas).push.apply(_a, respuesta);
            });
        }
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.peliculaService.getCartelera().subscribe(function (respuesta) {
            ...
            _this.peliculas = respuesta;
            // para queno se cargue denuevo el slider
            _this.peliculasSlider = respuesta;
        });
    };
